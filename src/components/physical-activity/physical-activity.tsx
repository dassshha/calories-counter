        ...
        <li className="radio">
          <div className="radio__wrapper">
            <input
              ...
              defaultValue="min"
              type="radio"
              checked={isChecked(physicalActivity.value, 'min')}
              onChange={physicalActivity.onChange}
              required
            />
        ...
        <li className="radio">
          <div className="radio__wrapper">
            <input
              ...
              defaultValue="low"
              type="radio"
              checked={isChecked(physicalActivity.value, 'low')}
              onChange={physicalActivity.onChange}
              required
            />
        ...
        <li className="radio">
          <div className="radio__wrapper">
            <input
              ...
              defaultValue="medium"
              type="radio"
              checked={isChecked(physicalActivity.value, 'medium')}
              onChange={physicalActivity.onChange}
              required
            />
        ...
        <li className="radio">
          <div className="radio__wrapper">
            <input
              ...
              defaultValue="high"
              type="radio"
              checked={isChecked(physicalActivity.value, 'high')}
              onChange={physicalActivity.onChange}
              required
            />
        ...
        <li className="radio">
          <div className="radio__wrapper">
            <input
              ...
              defaultValue="max"
              type="radio"
              checked={isChecked(physicalActivity.value, 'max')}
              onChange={physicalActivity.onChange}
              required
            />
