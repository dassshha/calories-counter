...
export const FormSubmit = ({age, height, weight}: FormSubmitProps): JSX.Element => {
  ...
  return (
      <div className="form__submit">
          <button className="form__submit-button button" name="submit" type="submit" disabled={isSubmitBtnDisabled}>
              Рассчитать
          </button>
          <button className="form__reset-button" name="reset" type="reset" disabled={isResetBtnDisabled}>
