...
export const FormSubmit = (): JSX.Element => {
  const [isDisabled, setIsDisabled] = useState(true);
  const age = useAppSelector(SelectorKey.Age);
  const height = useAppSelector(SelectorKey.Height);
  const weight = useAppSelector(SelectorKey.Weight);
  ...
  return (
      <div className="form__submit">
          <button className="form__submit-button button" name="submit" type="submit" disabled={isDisabled}>
              Рассчитать
          </button>
